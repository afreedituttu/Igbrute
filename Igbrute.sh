...
echo -e "\e[34m last update of key on 26/04/2021\e[0m"
echo -e "\e[31m
...
webs()
{
echo -e "\e[34m [1] Get the key on web\e[0m"
echo -e "\e[34m [2] Get stucked in ads, want solution?\e[0m"
...
am start -a android.intent.action.VIEW -d https://youtu.be/TdvsvaxLNeE
cd /$HOME/Igbrute
bash Igbrute.sh
else
echo "you selected invalid option"
...
customise()
{
echo -e "\e[31m [1] View wordlist \e[0m"
echo -e "\e[31m [2] Customise wordlist\e[0m\n"
echo -e -n "\e[34m select an option : \e[0m\n"
read custom
if [ $custom == 1 ]; then
